    ...
    options: [
        {
            ...
            menuValues: [
                ...
                },
                {
                    ...
                    valueLocation: '//div[@class="description m10b"]/span[text()="Single address wallets will not spawn new addresses for every transaction, change will always go to the one and only address the wallet contains."]',
