...
export const initialRunTermsOfUse = {

	'Skip to terms of use and check required points': (client: NightWatchClient): void => {
    ...
    'Open Terms of Use': (client: NightWatchClient): void => {
        const global: NightWatchClient = client.page.globalPage();
    ...
    'Agree to terms of use, confirm': (client: NightWatchClient): void => {
        const global: NightWatchClient = client.page.globalPage();
